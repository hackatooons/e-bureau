...
function NotFound() {
  return (
    <div className={styles.outerdiv}>
      <section className="flex flex-col justify-center items-center w-full max-w-xl min-h-screen text-white">
        <h4 className="text-lg md:text-xl font-space text-green-500 mb-5">
          UH OH! You're lost.
        </h4>
        <svg
          width="325"
        ...
        >
          <rect width="1123" height="837" fill="transparent" />
        ...
        <h2 className="font-Montserrat text-center relative mx-0 mb-5 w-full lg:text-6xl md:text-5xl sm:text-3xl">
          404
        </h2>
        <p className="text-center text-lg md:text-xl font-space">
        ...
        <div className="mt-6 sm:mt-10 flex justify-center space-x-6 text-sm">
          <NextLink href="/">
            <a className="bg-white text-black font-Montserrat font-medium hover:text-white hover:bg-green-600  border-[1px] border-solid rounded text-sm cursor-pointer no-underline py-4 px-7">
              Return Home
            </a>
          </NextLink>
        </div>
